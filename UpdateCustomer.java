...
public class UpdateCustomer extends JFrame implements ActionListener{
    ...
    UpdateCustomer(String username)
    {
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("tourism/icons/update.png"));
        Image i2=i1.getImage().getScaledInstance(400,300,Image.SCALE_DEFAULT);
        ImageIcon i3=new ImageIcon(i2);
        JLabel l10 = new JLabel(i3);
        l10.setBounds(400,40,450,350);
        add(l10);
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == b1) {
            ...
            String q = "update customer set username = '"+username+"', id = '"+id+"', number = '"+number+"', name = '"+name+"',gender = '"+radio+"', country = '"+country+"', address = '"+address+"', phone = '"+phone+"', email = '"+email+"' where username='"+username+"'";
            try {
                Conn c = new Conn();
                c.s.executeUpdate(q);
